...
/** Morocco WhatsApp — digits only for wa.me (same as +212 600 097 406) */
export const SITE_PHONE_E164 = "212600097406";
/** Human-readable, for display next to icons */
export const SITE_PHONE_DISPLAY = "+212 600 097 406";
