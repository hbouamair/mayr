...
import { mayrExperienceIntro } from "@/lib/mayr-experience-content";
  ...
  return (
    ...
    >
      <div className="mx-auto min-w-0 max-w-6xl px-4 py-20 sm:px-6 sm:py-24 lg:py-28">
        <div className="card-2026 card-2026--accent-terracotta relative overflow-hidden rounded-[1.5rem] border border-white/55 bg-gradient-to-br from-surface-elevated/98 via-parchment/95 to-sand/30 p-8 shadow-[0_28px_72px_-44px_rgba(36,28,23,0.22)] ring-1 ring-gold-logo/12 sm:p-10 md:p-12 lg:p-14">
          <span className="card-2026__noise pointer-events-none absolute inset-0 opacity-[0.04]" aria-hidden />
          <div
            className="home-calendar-float-orb-a pointer-events-none absolute -right-24 top-0 h-56 w-56 rounded-full bg-gradient-to-bl from-terracotta/16 to-transparent blur-3xl"
            aria-hidden
          />
          <div
            className="home-calendar-float-orb-b pointer-events-none absolute -left-20 bottom-0 h-48 w-48 rounded-full bg-gradient-to-tr from-gold-logo/14 to-transparent blur-3xl"
            aria-hidden
          />

          <div className="relative z-[1] mx-auto max-w-4xl">
            <div className="flex flex-wrap items-center gap-4">
              <span className="home-calendar-icon-pulse flex h-12 w-12 items-center justify-center rounded-2xl bg-terracotta/10 text-terracotta ring-1 ring-terracotta/15">
              ...
              <div>
                ...
                <EditorialSectionTitle
                  ...
                  scale="page"
                  align="left"
                  highlight={mayrExperienceIntro.titleHighlight}
                  rest={mayrExperienceIntro.titleRest}
                  className="mt-2 max-w-xl"
                />
              </div>
            </div>

            <p className="mt-8 font-body text-[17px] font-light leading-[1.85] text-muted md:text-[18px]">
              {mayrExperienceIntro.description}
            </p>

            <div className="mt-10 space-y-6 border-t border-border-subtle/70 pt-10">
